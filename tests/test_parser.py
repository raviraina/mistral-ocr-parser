...
class TestMistralOCRParser(unittest.TestCase):
    ...
    def test_get_signed_url(self, mock_mistral):
        ...
        # Verify
        mock_client.files.get_signed_url.assert_called_once_with(file_id="test_file_id", expiry=1)
    ...
    def test_parse_pdf_function(self, mock_parser_class):
        ...
        mock_parser.parse_pdf.assert_called_once_with(self.test_pdf_path, self.test_output_path)
